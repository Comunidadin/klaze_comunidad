 ...
 * su lista de lecciones debajo, con scroll suave hasta el panel. Si el curso
 * no existe o el usuario no tiene acceso, muestra un `EmptyState` en su
 * lugar — nunca la estructura interna del curso.
 */
